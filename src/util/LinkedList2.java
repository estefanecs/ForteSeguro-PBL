...
public class LinkedList2 {
    ...
    public int getPosicao(String n) {
        ...
        int posicao = 0;
        while (aux != null) {
            if (aux.getConteudo().getDestino().getNome().compareToIgnoreCase(n) == 0) {
                return posicao;
            }
            aux = aux.getNext();
            posicao++;
    ...
    public Vertice remove(String nome) {
        No aux = primeiro;
        No aux2 = primeiro;
        if (primeiro.getConteudo().getDestino().getNome().compareToIgnoreCase(nome) == 0) {
    ...
    public void addInicio(Aresta obj) {
